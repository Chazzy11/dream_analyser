...
class DreamAnalysis(BaseModel):
    ...
    upper_downer_score: float = Field(..., ge=-1.0, le=1.0, description="Emotional valence (-1 = downer, 1 = upper)")
    static_dynamic_score: float = Field(..., ge=-1.0, le=1.0, description="Energy level (-1 = static, 1 = dynamic)")
